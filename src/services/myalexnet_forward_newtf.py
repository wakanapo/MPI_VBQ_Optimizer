...
test_x, test_y = imagenet.load((227, 227))
...
net_data = np.load(open("data/bvlc_alexnet.npy", "rb"), encoding="latin1").item()
...
t = time.time()
output = sess.run(accuracy, feed_dict = {x:test_x, y_:test_y})
################################################################################
